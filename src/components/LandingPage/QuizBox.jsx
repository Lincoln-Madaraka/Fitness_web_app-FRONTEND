...
const QuixBox = () => {
  ...
  return (
    <div className="self-stretch [background:linear-gradient(200deg,_#0066ee_60%,_#9383fb)] overflow-hidden flex flex-row py-[100px] px-[200px] items-center justify-center gap-[55px] text-whitesmoke-200 md:flex-col sm:flex-col sm:py-[50px] sm:px-[30px] sm:box-border">
    <div className="flex-1 flex flex-col items-start justify-center gap-[18px] md:flex-[unset] md:self-stretch sm:flex-[unset] sm:self-stretch sm:h-auto">
      <p className="m-0 self-stretch relative leading-[24px] font-semibold">
        Have 2 mins?
      </p>
    ...
    <img
      ...
      alt=""
      src="/LandingPage/bro.png"
    />
  </div>
  );
};

export default QuixBox;
